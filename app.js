...
function drawThreeLoadPhaseFocus(root,analysis){
  ...
  $('threeLoadFocusNote').textContent=`Lokal visningsreference: ${referenceName}. Δ-grene beregnes med fase-fase-spænding, men vinkler vises i forhold til denne fase.`;
}
