...
const trig = (fn, top, bottom) => `<span class="math-term">${fn}(${frac(top,bottom)})</span>`;
...
function applyFormulaFractions(root=document){
  $$('.formula-badge,.formula-main,.formula-stack p,.transform-formula-columns p,.formula-grid strong,.formula-grid small,.formula-library strong,.formula-library p,.triangle-library strong,.triangle-library p,.symmetric-equation,.formula-foot,.angle-pill',root).forEach(el=>{
