...
function drawThreeDiagram(root,connection,phi,currentView){
  ...
  if(connection==='Y'){root.append(svg('circle',{cx,cy,r:4,fill:CURRENT_COLOR,opacity:.95}));text(root,cx+16,cy+19,'I₀ = 0 A','vector-label',CURRENT_COLOR);}
  ...
  text(root,260,304,connection==='Y'?'Stjerne: Uₙ = √3 · U_f, Iₙ = I_z og I₀ = 0 A':currentView==='line'?'Trekant: Iₙ er vektorforskellen mellem to komponentstrømme':'Trekant: Iₙ = √3 · I_z og er 30° forskudt','vector-label','#6f7e89','middle');
}
...
function drawThreeLoad(){
  ...
  $('threeLoadIFormula').textContent=asym?'se Iₙ1, Iₙ2, Iₙ3 og I₀ i diagrammet':threeLoadConnection==='Y'?'Iₙ = I_z':`Iₙ = √3 · I_z (${da(If,2)} A)`;$('threeLoadPFormula').textContent=asym?'Σ(U_gren · I_gren · cosφ_gren)':'√3 · Uₙ · Iₙ · |cosφ|';
